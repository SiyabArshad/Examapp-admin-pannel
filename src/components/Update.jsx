...
const[catg,setcatg]=React.useState("FPT")
    ...
    <div style={{ width: '100%',padding:"1rem" }}>
      ...
      <Grid container spacing={3}>
        ...
        >
          ...
          <MenuItem value="FPTAC">FPTAC</MenuItem>
        </Select>
        </Grid>
        <Grid item xs={12} sm={6}>
        ...
        <IconButton style={{color:"#4169e1"}} aria-label="upload picture" component="span">
          <PhotoCamera />
        </IconButton>
      </label>
        ...
        <Grid item xs={12} sm={6}>
        <Button onClick={questionsform} variant="contained" style={{backgroundColor:"#4169e1"}} >
                    Update Question
        </Button>
        </Grid>
